...
public class ApplicantViewPage extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.applicant_account_details_page);
        ...
        // Initialize NavBar
        HelperFunctions.initializeNavBar(ApplicantViewPage.this);
        ...
        viewButton.setOnClickListener(view -> {
            if (intent != null && intent.hasExtra("user")) {
                User user = (User) intent.getSerializableExtra("user");
                Intent intent2 = new Intent(ApplicantViewPage.this, ApplicantEditPage.class);
